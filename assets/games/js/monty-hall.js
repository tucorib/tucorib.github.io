...
function startRun(){
	...
	if(!autoRun){
		...
		// Reset doors
		$('#img-door-1').attr('src', '/assets/games/img/door-closed.png');
		$('#img-door-2').attr('src', '/assets/games/img/door-closed.png');
		$('#img-door-3').attr('src', '/assets/games/img/door-closed.png');
	}
